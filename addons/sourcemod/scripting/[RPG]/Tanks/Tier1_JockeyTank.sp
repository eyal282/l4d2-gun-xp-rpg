...
{
	tankIndex = RPG_Tanks_RegisterTank(1, 3, "Jockey", "A tank that likes Jockeys\nAll Special Infected spawned will be Jockeys instead\nThis tank shoots jockeys from his arms, and you will be pinned if it hits you.", "All SI become Jockey. Getting hit pins you. Melee does 2x damage.", 200000, 180, 1.0, 150, 200,  DAMAGE_IMMUNITY_BURN, GunXP_GenerateHexColor(148, 0, 211));
