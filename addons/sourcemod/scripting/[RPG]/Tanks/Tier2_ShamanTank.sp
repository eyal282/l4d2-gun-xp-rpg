...
{
	tankIndex = RPG_Tanks_RegisterTank(2, 3, "Shaman", "A wizard Tank that uses magical abilities to kill survivors.", 5000000, 180, 0.3, 1300, 2100, DAMAGE_IMMUNITY_BURN);
